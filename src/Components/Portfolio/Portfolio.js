        ...
        <Row >
          ...
          <Col md={{ span: 5, offset: 2 }}>
            <ProjectComponent1
              ...
              projectTools={'AniList API, Passport, Node, Express, JWT Authentication, MYSQL, HTML, Javascript, Metro4'} githubLink={'https://github.com/Psong562/anotherAnimeArchive.git'}
        ...
        <Row className="justify-content-center" >
          <Col md={5}>
            ...
            <ProjectComponent1
              ...
              projectTools={'Mongodb, Express, React, NodeJS, Passport, JWT Authentication,  Javascript, SocketIO, Quill, React Boostrap, Framer Motion'} githubLink={'https://github.com/Psong562/lofiStudyRoom'}
